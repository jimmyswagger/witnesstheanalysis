---
title: "Kerry (1.18) vs Dublin (2.14)"
output:
  html_document:
    toc: true
    toc_float: true 
...
pass <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kervsdub/gamelogkervsdub.csv", header=TRUE, sep=";")
attach (pass)

position  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kervsdub/positionkervsdub.csv", header=TRUE, sep=";")
attach (position)

scorelist  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kervsdub/scorelistkervsdub.csv", header=TRUE, sep=";")
attach (scorelist)

summary  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kervsdub/summarykervsdub.csv", header=TRUE, sep=";")
attach (summary)

scores  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kervsdub/scoreskervsdub.csv", header=TRUE, sep=";")
attach (scores)

passtofrom  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kervsdub/passtofromkervsdub.csv", header=TRUE, sep=";")
attach (passtofrom)

passmap  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kervsdub/passmapkervsdub.csv", header=TRUE, sep=";")
attach (passmap)

scrd  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kervsdub/shotvertkervsdub.csv", header=TRUE, sep=";")
attach (scrd)

plytree  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kervsdub/plytreekervsdub.csv", header=TRUE, sep=";")
attach (plytree)

linksteamAB <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kervsdub/linkkervsdub.csv", header=TRUE, sep=";")
attach (linksteamAB)


nodesteamA <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kervsdub/nodeskervsdub.csv", header=TRUE, sep=";")
attach (nodesteamA)

nodesteamB <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kervsdub/nodesdubker.csv", header=TRUE, sep=";")
attach (nodesteamB)

plystats <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kervsdub/plystatskervsdub.csv", header=TRUE, sep=";")
attach (plystats)
...
p + geom_point(data = positionA, aes(x=Areax, y=Areay, shape = Team), colour = "yellow",size = 6) +
  theme(plot.title = element_text( size=32, hjust=0)) +
  geom_text_repel(data = positionA, aes(x=Areax, y=Areay, label = Player), colour = "yellow", size = 8) +
...
p + geom_point(data = positionB, aes(x=Areax, y=Areay, shape = Team), colour = "darkblue",size = 6) +
  theme(plot.title = element_text( size=32, hjust=0)) +
  geom_text_repel(data = positionB, aes(x=Areax, y=Areay, label = Player), colour = "darkblue", size = 8) +
  theme(legend.position="none")
...
ggplot(data=scores, aes(x=time, y=score, group=Team)) +
    ...
    geom_point(data = wormB, shape = 1, size = 4, stroke = 2, colour = "darkblue") +
    theme_classic() + 
    ...
    axis.ticks = element_blank(), 
    axis.title.x = element_blank()) +
    geom_text_repel(data = wormA, aes(x=time, y=score, label = shotlab), size = 6, colour = "green", nudge_y = 2, 
    segment.size  = 0.2,  direction = "x", hjust = 1 ) + 
    geom_text_repel(data = wormB, aes(x=time, y=score, label = shotlab), size = 6, colour = "darkblue", nudge_x = 4, nudge_y = -2, 
...
geom_vline(xintercept=17.5, linetype="dotted", color = "black") +
 ...
 geom_vline(xintercept=52.5, linetype="dotted", color = "black") +  
 geom_vline(xintercept=77, linetype="dotted", color = "black") +
    annotate(geom="text", x=1.5, y=4.5, label="Kerry", color="lightgreen", size = 16) +
    theme(plot.background = element_blank(),
...
p + geom_point(data = avgposA, aes(x=AreaxA, y=AreayA), colour = "yellow", size = 6) +
...
p + geom_point(data = avgposB, aes(x=AreaxB, y=AreayB), colour = "darkblue", size = 6) +
...
p + geom_path(data = B1, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B2, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B3, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B4, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B5, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B6, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B7, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B8, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B9, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B10, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B11, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B12, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B13, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B14, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B15, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B16, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B17, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B18, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B19, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B20, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B21, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B22, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B23, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B24, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B25, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B26, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B27, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B28, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B29, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B30, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B31, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B32, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B33, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B34, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B35, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B36, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B37, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B38, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B39, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B40, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B41, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B42, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B43, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B44, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B45, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B46, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B47, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B48, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = B49, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") 
...
```{r, fig.width = 16, fig.height = 10}
conqmapA <-filter(pass, Teamnum == "A", Action == "Tack W"|Action == "KP Int"|Action == "HP Int"|Action == "Kp Brk Int"|
Action == "Hp Brk Int"|Action == "Kp Free Int"|Action == "Fk Brk Int"|
Action == "Mk Kp Int"|Action == "Sl Int"|Action == "Sl Brk Int"|
Action == "Ko Int"|Action == "KoBrk Int"|Action == "Ko Int Mk"|
Action == "Fk Short Gk"|Action == "Short Gk"|Action == "Loose TBW"|Action == "Free Won Def"|
...
p + geom_point(data = conqmapA, aes(x=Areax, y=Areay, colour = Action, shape = Team), size = 6)+
...
##Dublin
```{r, fig.width = 16, fig.height = 10}
conqmapB <-filter(pass, Teamnum == "B", Action == "Tack W"|Action == "KP Int"|Action == "HP Int"|Action == "Kp Brk Int"|
Action == "Hp Brk Int"|Action == "Kp Free Int"|Action == "Fk Brk Int"|
Action == "Mk Kp Int"|Action == "Sl Int"|Action == "Sl Brk Int"|
Action == "Ko Int"|Action == "KoBrk Int"|Action == "Ko Int Mk"|
Action == "Fk Short Gk"|Action == "Short Gk"|Action == "Loose TBW"|Action == "Free Won Def"|
...
linksA <- linksteamAB %>% filter( Teamnum == "A") %>% select(Teamnum,plypass, plyrec)
...
plot(netA, edge.arrow.size=.4, edge.color="yellow",edge.arrow.width=.4,
      edge.width=E(netA)$weight*5, layout=as.matrix(nodes.coordA[,c("x","y")]), vertex.label.color="yellow", vertex.label = label, vertex.label.cex = 5)
...
```{r, fig.width = 20, fig.height = 20}
linksB <- linksteamAB %>% filter( Teamnum == "B") %>% select(Teamnum,plypass, plyrec)
...
# Generate colors based on number of position (ie gk back mf for) type:
colrs <- c("lightblue", "lightblue", "lightblue", "lightblue")
...
plot(netB, edge.arrow.size=.4, edge.color="darkblue",edge.arrow.width=.4,
      edge.width=E(netB)$weight*5, layout=as.matrix(nodes.coordB[,c("x","y")]), vertex.label.color="darkblue",  vertex.label = label, vertex.label.cex = 5)
