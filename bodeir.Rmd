...
pass <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/passbodeir.csv", header=TRUE, sep=";")
attach (pass)

passline <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/passlinebodeir.csv", header=TRUE, sep=";")
attach (passline)

position  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/positionbodeir.csv", header=TRUE, sep=";")
attach (position)

plytree  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/plytreebodeir.csv", header=TRUE, sep=";")
attach (plytree)

plystats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/plystatsbodeir.csv", header=TRUE, sep=";")
attach (plystats)

passmap  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/passmapbodeir.csv", header=TRUE, sep=";")
attach (passmap)

scorelist  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/scorelistbodeir.csv", header=TRUE, sep=";")
attach (scorelist)

summary  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/summarybodeir.csv", header=TRUE, sep=";")
attach (summary)

scores  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/scoresbodeir.csv", header=TRUE, sep=";")
attach (scores)

scrd  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/scrdbodeir.csv", header=TRUE, sep=";")
attach (scrd)

shots <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/shotsbodeir.csv", header=TRUE, sep=";")
attach (shots)

passtofrom  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/passtofrombodeir.csv", header=TRUE, sep=";")
attach (passtofrom)

attstats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/attstatsbodeir.csv", header=TRUE, sep=";")
attach (attstats)

origtime <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/origtimebodeir.csv", header=TRUE, sep=";")
attach (origtime)

shotstats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/shotstatsbodeir.csv", header=TRUE, sep=";")
attach (shotstats)

koeff <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/koeffbodeir.csv", header=TRUE, sep=";")
attach (koeff)

rseff <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/rseffbodeir.csv", header=TRUE, sep=";")
attach (rseff)

overview <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/overbodeir.csv", header=TRUE, sep=";")
attach (overview)

run <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/runbodeir.csv", header=TRUE, sep=";")
attach (run)
...
passbd<- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/passbdbodeir.csv", header=TRUE, sep=";")
attach (passbd)

tack <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/tackbodeir.csv", header=TRUE, sep=";")
attach (tack)

ppda <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/ppdabodeir.csv", header=TRUE, sep=";")
attach (ppda)
...
###Ballyboden Total
```{r}
run%>%filter(Teamnum=="A",keep=="Y", Areax <98.9 & xend > 99 )%>%summarize(count=n())
...
run%>%filter(Teamnum=="A",keep=="Y", Areax <98.9 & xend > 99, seg == "1" )%>%summarize(count=n())
...
```{r}
run%>%filter(Teamnum=="A",keep=="Y", Areax <98.9 & xend > 99, seg == "2"| seg == "0" )%>%summarize(count=n())
```

###Ballyboden Kick Pass Right

```{r}
run%>%filter(Teamnum=="A",keep=="Y",  Areax <98.9 & xend > 99, seg == "3" )%>%summarize(count=n())
```

###Ballyboden Pass Lost

```{r}
run%>%filter(Teamnum=="A",keep=="Y", Areax <98.9 & xend > 99, seg == "7" )%>%summarize(count=n())
...
run%>%filter(Teamnum=="A",keep=="Y", Areax <98.9 & xend > 99, seg == "9" )%>%summarize(count=n())
...
run%>%filter(Teamnum=="A",keep=="Y", Areax <98.9 & xend > 99, seg == "10" )%>%summarize(count=n())
```


###Eire Og Total
```{r}
run%>%filter(Teamnum=="B",keep=="Y", Areax <98.9 & xend > 99)%>%summarize(count=n())
...
run%>%filter(Teamnum=="B",keep=="Y", Areax <98.9 & xend > 99, seg == "1" )%>%summarize(count=n())
...
```{r}
run%>%filter(Teamnum=="B",keep=="Y", Areax <98.9 & xend > 99, seg == "2"| seg == "0" )%>%summarize(count=n())
```

###Eire Og Kick Pass Right

```{r}
run%>%filter(Teamnum=="B",keep=="Y", Areax <98.9 & xend > 99, seg == "3" )%>%summarize(count=n())
```

###Eire Og Pass Lost

```{r}
run%>%filter(Teamnum=="B",keep=="Y", Areax <98.9 & xend > 99, seg == "7" )%>%summarize(count=n())

```

###Eire Og Kick Pass Left

```{r}

run%>%filter(Teamnum=="B",keep=="Y", Areax <98.9 & xend > 99, seg == "9" )%>%summarize(count=n())

```

###Eire Og Fk/Mk/Sl Pass

```{r}

run%>%filter(Teamnum=="B",keep=="Y", Areax <98.9 & xend > 99, seg == "10" )%>%summarize(count=n())
```
...
linksABs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/linkskobodeir.csv", header=TRUE, sep=";")
attach (linksABs)

nodesteamAko <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/nodeskobodeir.csv", header=TRUE, sep=";")
attach (nodesteamAko)
...
nodesteamBko <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/bodeir/nodeskoeirbod.csv", header=TRUE, sep=";")
attach (nodesteamBko)
...
p + geom_point(data = defactA, aes(x = Areax, y = Areay),colour = "black", size = 7)
...
p + geom_point(data = defactB, aes(x = Areax, y = Areay),colour = "black", size = 7)
...
p + geom_segment(data = runA, aes(x = Areax, y = Areay, xend = xend, yend = yend, colour = as.factor(Asht)),size = .8,arrow = arrow()) +
  geom_point(data = runA, aes(x=Areax, y=Areay), colour = "white",size = 5, shape = 19) +
  geom_text(data = runA, aes(x=Areax, y=Areay, label = possno), colour = "black", size = 3) +
...
passPW <- run %>%group_by(Team, Action) %>% filter(Teamnum == "B",main =="PW")
passKo <- run%>%group_by(Team, Action) %>% filter(Teamnum == "B",main=="Ko Rec")
passRs <- run%>%group_by(Team, Action) %>% filter(Teamnum == "B",main=="Pass Rs")
passOp <- run%>%group_by(Team, Action) %>% filter(Teamnum == "B",main=="Shot Op")

runB <- run%>%filter(Teamnum=="B",keep=="Y")



p + geom_segment(data = runB, aes(x = Areax, y = Areay, xend = xend, yend = yend, colour = as.factor(Bsht)),size = .8,arrow = arrow()) +
    geom_point(data = runB, aes(x=Areax, y=Areay), colour = "white",size = 5, shape = 19) +
  geom_text(data = runB, aes(x=Areax, y=Areay, label = possno), colour = "black", size = 3) +
    theme(legend.position="none") + scale_colour_manual(values = actcolpals) +
  geom_point(data = passPW, aes(x=Areax, y=Areay, stroke = 1), size = 7, colour = "white", shape = 16) +
geom_text(data = passPW, aes(x=Areax, y=Areay, label = possno),colour = "black") +
geom_point(data = passRs, aes(x=Areax, y=Areay, stroke = 1), size = 7, colour = "blue", shape = 16) +
...
p + geom_segment(data = runA, aes(x = Areax, y = Areay, xend = xend, yend = yend, colour = as.factor(Ascr)),size = .8,arrow = arrow()) +
  geom_point(data = runA, aes(x=Areax, y=Areay), colour = "white",size = 5, shape = 19) +
  geom_text(data = runA, aes(x=Areax, y=Areay, label = possno), colour = "black", size = 3) +
    theme(legend.position="none") + scale_colour_manual(values = actcolpals) +
  geom_point(data = passPW, aes(x=Areax, y=Areay, stroke = 1), size = 7, colour = "white", shape = 16) +
...
p + geom_segment(data = runB, aes(x = Areax, y = Areay, xend = xend, yend = yend, colour = as.factor(Bscr)),size = .8,arrow = arrow()) +
   geom_point(data = runB, aes(x=Areax, y=Areay), colour = "white",size = 5, shape = 19) +
  geom_text(data = runB, aes(x=Areax, y=Areay, label = possno), colour = "black", size = 3) +
    theme(legend.position="none") + scale_colour_manual(values = actcolpals) +
  geom_point(data = passPW, aes(x=Areax, y=Areay, stroke = 1), size = 7, colour = "white", shape = 16) +
...
###Free Kick Shot Efficiency - Eire Og
```{r, fig.width = 16, fig.height = 10}
...
#passing to from
advpassA <- passtofrom %>% filter(Areax <98.9 & xend > 99 , Teamnum == "A")
...
```{r, fig.width = 16, fig.height = 10}
advpassB <- passtofrom %>% filter(Areax <98.9 & xend > 99, Teamnum == "B")
...
#passing to from
advpassA <- passtofrom %>% filter(Areax >78.9, Teamnum == "A")
...
```{r, fig.width = 16, fig.height = 10}
advpassB <- passtofrom %>% filter(Areax >78.9, Teamnum == "B")
