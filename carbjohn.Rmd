---
title: "Carbury (0.13) vs Johnstown (1.13)"
output:
  html_document:
    toc: true
    toc_float: true 
...
position  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/positioncarbjohn.csv", header=TRUE, sep=";")
attach (position)

plytree  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/plytreecarbjohn.csv", header=TRUE, sep=";")
attach (plytree)

plystats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/plystatscarbjohn.csv", header=TRUE, sep=";")
attach (plystats)

passmap  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/passmapcarbjohn.csv", header=TRUE, sep=";")
attach (passmap)

scorelist  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/scorelistcarbjohn.csv", header=TRUE, sep=";")
attach (scorelist)

summary  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/summarycarbjohn.csv", header=TRUE, sep=";")
attach (summary)

scores  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/scorescarbjohn.csv", header=TRUE, sep=";")
attach (scores)

scrd  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/scrdcarbjohn.csv", header=TRUE, sep=";")
attach (scrd)

shots <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/shotscarbjohn.csv", header=TRUE, sep=";")
attach (shots)

passtofrom  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/passtofromcarbjohn.csv", header=TRUE, sep=";")
attach (passtofrom)

attstats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/attstatscarbjohn.csv", header=TRUE, sep=";")
attach (attstats)

origtime <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/origtimecarbjohn.csv", header=TRUE, sep=";")
attach (origtime)

shotstats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/shotstatscarbjohn.csv", header=TRUE, sep=";")
attach (shotstats)

koeff <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/koeffcarbjohn.csv", header=TRUE, sep=";")
attach (koeff)

overview <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/overcarbjohn.csv", header=TRUE, sep=";")
attach (overview)

run <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/runcarbjohn.csv", header=TRUE, sep=";")
attach (run)
...
p + geom_point(data = positionA, aes(x=Areax, y=Areay, shape = Team), colour = "blue",size = 6) +
...
# Plot
ggplot(overview, aes(x=Stat, y=Carbury)) + 
  geom_point(data = overview,aes(x=Stat, y=Carbury), col="blue", size=10) +  
  geom_point(data = overview,aes(x=Stat, y=Johnstown), col="green", size= 10) +
  geom_segment(aes(x=Stat, xend=Stat, y=min(Johnstown), yend=max(Johnstown)), 
  linetype="dashed", size=0.1,colour = "grey") +     
  coord_flip() +
geom_text(data = overview,aes(x=Stat, y=Carbury,label = Carbury), size = 6,col="yellow") +
geom_text(data = overview,aes(x=Stat, y=Johnstown,label = Johnstown), size = 6,col="blue") +
my_theme ()
...
goal_theme <- function(){
  theme_classic() +
    theme(text = element_blank(),  
      ...
      annotate(geom="text", x= 1.50, y=3.5, label="Point - 13",color = "black",size = 14) + 
      annotate(geom="text", x= 2.50, y=3, label="Wide Right - 6",color = "black",size = 14) + 
      annotate(geom="text", x= .50, y=3, label="Wide Left - 3",color = "black",size = 14) + 
      annotate(geom="text", x= 1, y=.5, label="Short/Post - 2",color = "black",size = 14) + 
      annotate(geom="text", x= 2, y=.5, label="Save/Blkd - 1",color = "black",size = 14) +
      annotate(geom="text", x= 0.5, y=4.7, label="Carbury",color = "black",size = 18)  +
      ...
      annotate(geom="text", x= 1, y=.5, label="Short/Post - 5",color = "black",size = 14) + 
      annotate(geom="text", x= 2, y=.5, label="Save/Blkd - 2",color = "black",size = 14) +
      annotate(geom="text", x= 0.5, y=4.7, label="Johnstown",color = "black",size = 18)  +
      annotate(geom="text", x= 0.5, y=4.4, label="Total Shots - 28",color = "black",size = 16)  +
      goal_theme ()
...
##Scoring Timeline
```{r, fig.width = 16, fig.height = 10}
wormA <-scores%>%filter(Teamnum == "A", subsetoc =="Start"|subsetoc =="Scr Op"|subsetoc =="Scr Rs")%>%select(Team, octype,xend,yend,plylabrec,main,timeoc,shotlab,score,direction,scorediff,scrd)
...
ggplot(data=scores, aes(x=timeoc, y=score, group=Team)) +
    geom_step(data=wormA, aes(x=timeoc, y=score), colour = "yellow", ,size=2) + 
    geom_step(data=wormB, aes(x=timeoc, y=score), colour = "lightgreen", size=2) + 
    ...
    axis.title.x = element_blank()) +
    geom_text_repel(data = wormA, aes(x=timeoc, y=score, label = shotlab), size = 6, colour = "blue",  
    segment.size  = 0.2,  direction = "x", hjust = 1 ) + 
    geom_text_repel(data = wormB, aes(x=timeoc, y=score, label = shotlab), size = 6, colour = "blue",  
...
geom_vline(xintercept=15, linetype="dotted", color = "black") +
 geom_vline(xintercept=32, linetype="dotted", color = "black") +
 geom_vline(xintercept=45, linetype="dotted", color = "black") + 
 geom_vline(xintercept=64, linetype="dotted", color = "black") +
    annotate(geom="text", x=2, y=4.5, label="Carbury", color="red", size = 16) +
    annotate(geom="text", x=2.5, y=-4.5, label="Johnstown", color="purple", size = 16) +
    theme(plot.background = element_blank(),
    ...
    axis.title.x = element_blank(),
    axis.title.y = element_blank()) +
annotate(geom="text", x= 15, y=-0.25, label="1Qtr",color = "black") +
      annotate(geom="text", x= 32, y=-0.25, label="HT",color = "black") +
      annotate(geom="text", x= 45, y=-0.25, label="3Qtr",color = "black") +
      annotate(geom="text", x= 68, y=-0.25, label="FT",color = "black") 
...
Dubden <- pass %>%group_by(Player, main)%>%filter( Teamnum == "B", main == "PW"|main == "Rec Op"|main == "Rec Rs"|main == "Pass Op"|main == "Pass Rs"|main == "Shot Op"|main == "Shot Rs"|main == "Ko Rec"|main == "Fkwns"|main == "Fkws"|main == "Fklns"|main == "Fkls"| main == "Spoil Def" |main == "Spoil Off")
p  +  geom_density_2d(data = Dubden, aes(x=Areax, y=Areay),colour = "blue") +
    geom_point(data = Dubden, aes(x=Areax, y=Areay), colour = "white", shape=19, size = 2)+ 
    theme_classic () +  
    theme(axis.title.x=element_blank(),
...
actAA <- run%>% filter(Teamnum == "A", subset == "Pass ToL")

actAAA <- run%>% filter(Teamnum == "A", subset == "Fkws")

actAAAA <- run%>% filter(Teamnum == "A", subset == "Fkwns")
...
p + geom_segment(data = runA, aes(x = Areax, y = Areay, xend = xend, yend = yend, colour = as.factor(seg),linetype= as.factor(seg)),size = .5) +
    ...
    geom_point(data = actAAA, aes(x=Areax, y=Areay), colour = "blue" ,size = 3, shape = 19) +
    geom_point(data = actAAAA, aes(x=Areax, y=Areay), colour = "blue" ,size = 3, shape = 19) +
    labs(title = "(Lines: Black/Dashed = Handpass/Ko/Fk Pass, White/Dashed = Kp Right/Kp Left, Blue = Run, Red/Dashed = Lost Pass/Miss Op, Yellow = Score Op; Dots: Purple = PW, Blue = Fk Won, Red = Lost Poss)",size = 14)
...
actB <- run%>% filter(Teamnum == "B", main == "PW")

actBB <- run%>% filter(Teamnum == "B", subset == "Pass ToL")

actBBB <- run%>% filter(Teamnum == "B", subset == "Fkws")

actBBBB <- run%>% filter(Teamnum == "B", subset == "Fkwns")
...
p + geom_segment(data = runB, aes(x = Areax, y = Areay, xend = xend, yend = yend, colour = as.factor(seg),linetype= as.factor(seg)),size = .5) +
    ...
    geom_point(data = actBB, aes(x=Areax, y=Areay), colour = "red" ,size = 3, shape = 19) + 
    geom_point(data = actBBB, aes(x=Areax, y=Areay), colour = "blue" ,size = 3, shape = 19) +
...
linksABs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/linkskocarbjohn.csv", header=TRUE, sep=";")
attach (linksABs)

nodesteamAko <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/nodeskocarbjohn.csv", header=TRUE, sep=";")
attach (nodesteamAko)
...
colrs <- c("yellow", "darkblue", "darkblue", "darkblue", "darkblue")
...
plot(netAko, edge.arrow.size=.4, edge.color="yellow",edge.arrow.width=.4,
      edge.width=E(netAko)$weight*5, layout=as.matrix(nodes.coordA[,c("x","y")]), vertex.label.color="blue", vertex.label = labkoA, vertex.label.cex = 5)
...
nodesteamBko <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/nodeskojohncarb.csv", header=TRUE, sep=";")
attach (nodesteamBko)
...
# Generate colors based on number of position (ie gk back mf for) type:
colrs <- c("blue", "purple", "purple","purple","purple")
...
plot(netBko, edge.arrow.size=.4, edge.color="green",edge.arrow.width=.4,
      edge.width=E(netBko)$weight*5, layout=as.matrix(nodes.coordB[,c("x","y")]), vertex.label.color="blue",  vertex.label = labkoB, vertex.label.cex = 5)
...
```{r}
knitr::opts_chunk$set(echo = FALSE, message=FALSE, warning=FALSE, options(knitr.kable.NA = ''))
kable (attstats)%>% kable_styling(bootstrap_options=c("striped"))%>%row_spec(9, bold = T)
...
```{r}
knitr::opts_chunk$set(echo = FALSE, message=FALSE, warning=FALSE, options(knitr.kable.NA = ''))
kable (shotstats)%>% kable_styling(bootstrap_options=c("striped"))%>%row_spec(3, bold = T)
...
```{r}
knitr::opts_chunk$set(echo = FALSE, message=FALSE, warning=FALSE, options(knitr.kable.NA = ''))
kable (origtime)%>% kable_styling(bootstrap_options=c("striped"))%>%row_spec(9, bold = T)
...
linksABps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/passshotcarbjohn.csv", header=TRUE, sep=";")
attach (linksABps)

nodesteamAps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/nodesshotcarbjohn.csv", header=TRUE, sep=";")
attach (nodesteamAps)
...
plot(netAps, edge.arrow.size=.4, edge.color="yellow",edge.arrow.width=.4,
      edge.width=E(netAps)$weight*5, layout=as.matrix(nodes.coordA[,c("x","y")]), vertex.label.color="yellow", vertex.label = labelAsh, vertex.label.cex = 5)
```
...
nodesteamBps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/nodesshotjohncarb.csv", header=TRUE, sep=";")
attach (nodesteamBps)
...
plot(netBps, edge.arrow.size=.4, edge.color="green",edge.arrow.width=.4,
      edge.width=E(netBps)$weight*5, layout=as.matrix(nodes.coordB[,c("x","y")]), vertex.label.color="green",  vertex.label = labelBsh, vertex.label.cex = 5)
...
linksABs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/linksscorescarbjohn.csv", header=TRUE, sep=";")
attach (linksABps)

nodesteamAs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/nodesscorecarbjohn.csv", header=TRUE, sep=";")
attach (nodesteamAs)
...
# Generate colors based on number of position (ie gk back mf for) type:
colrs <- c("blue", "darkblue", "darkblue", "darkblue", "darkblue")
...
plot(netAs, edge.arrow.size=.4, edge.color="yellow",edge.arrow.width=.4,
      edge.width=E(netAs)$weight*5, layout=as.matrix(nodes.coordA[,c("x","y")]), vertex.label.color="yellow", vertex.label = labAscr, vertex.label.cex = 5)
...
nodesteamBs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/nodesscorejohncarb.csv", header=TRUE, sep=";")
attach (nodesteamBs)
...
plot(netBs, edge.arrow.size=.4, edge.color="green",edge.arrow.width=.4,
      edge.width=E(netBs)$weight*5, layout=as.matrix(nodes.coordB[,c("x","y")]), vertex.label.color="green",  vertex.label = labBscr, vertex.label.cex = 5)
...
```{r, fig.width = 20, fig.height = 20}
linksAB <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/linkscarbjohn.csv", header=TRUE, sep=";")
attach (linksAB)

nodesteamA <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/nodescarbjohn.csv", header=TRUE, sep=";")
attach (nodesteamA)
...
plot(netA, edge.arrow.size=.4, edge.color="yellow",edge.arrow.width=.4,
...
nodesteamB <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/carbjohn/nodesjohncarb.csv", header=TRUE, sep=";")
attach (nodesteamB)
...
plot(netB, edge.arrow.size=.4, edge.color="green",edge.arrow.width=.4,
      edge.width=E(netB)$weight*5, layout=as.matrix(nodes.coordB[,c("x","y")]), vertex.label.color="green",  vertex.label = labelB, vertex.label.cex = 5)
