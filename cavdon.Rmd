...
pass <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/passcavdon.csv", header=TRUE, sep=";")
attach (pass)

position  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/positioncavdon.csv", header=TRUE, sep=";")
attach (position)

plytree  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/plytreecavdon.csv", header=TRUE, sep=";")
attach (plytree)

plystats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/plystatscavdon.csv", header=TRUE, sep=";")
attach (plystats)

passmap  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/passmapcavdon.csv", header=TRUE, sep=";")
attach (passmap)

scorelist  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/scorelistcavdon.csv", header=TRUE, sep=";")
attach (scorelist)

summary  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/summarycavdon.csv", header=TRUE, sep=";")
attach (summary)

scores  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/scorescavdon.csv", header=TRUE, sep=";")
attach (scores)

scrd  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/scrdcavdon.csv", header=TRUE, sep=";")
attach (scrd)

shots <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/shotscavdon.csv", header=TRUE, sep=";")
attach (shots)

passtofrom  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/passtofromcavdon.csv", header=TRUE, sep=";")
attach (passtofrom)

attstats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/attstatscavdon.csv", header=TRUE, sep=";")
attach (attstats)

origtime <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/origtimecavdon.csv", header=TRUE, sep=";")
attach (origtime)

shotstats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/shotstatscavdon.csv", header=TRUE, sep=";")
attach (shotstats)

koeff <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/koeffcavdon.csv", header=TRUE, sep=";")
attach (koeff)

overview <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/overcavdon.csv", header=TRUE, sep=";")
attach (overview)

run <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/runcavdon.csv", header=TRUE, sep=";")
attach (run)
...
# Plot
ggplot(overview, aes(x=Stat, y=Cavan)) + 
  geom_point(data = overview,aes(x=Stat, y=Cavan), col="blue", size=10) +  
  geom_point(data = overview,aes(x=Stat, y=Donegal), col="lightgreen", size= 10) +
  geom_segment(aes(x=Stat, xend=Stat, y=min(Donegal), yend=max(Donegal)), 
  linetype="dashed", size=0.1,colour = "grey") +     
  coord_flip() +
geom_text(data = overview,aes(x=Stat, y=Cavan,label = Cavan), size = 6,col="white") +
...
goal_theme <- function(){
  theme_classic() +
    theme(text = element_blank(),  
      ...
      annotate(geom="text", x= 1, y=.5, label="Short/Post - 6/1",color = "black",size = 14) + 
      annotate(geom="text", x= 2, y=.5, label="Save/Blkd - 1/0",color = "black",size = 14) +
      annotate(geom="text", x= 0.5, y=4.7, label="Cavan",color = "black",size = 18)  +
      annotate(geom="text", x= 0.5, y=4.4, label="Total Shots - 34",color = "black",size = 16)  +
      goal_theme ()
      ...
      annotate(geom="text", x= 1.50, y=3.5, label="Point - 24",color = "black",size = 14) + 
      annotate(geom="text", x= 2.50, y=3, label="Wide Right - 5",color = "black",size = 14) + 
      annotate(geom="text", x= .50, y=3, label="Wide Left - 3",color = "black",size = 14) + 
      ...
      annotate(geom="text", x= 0.5, y=4.4, label="Total Shots - 39",color = "black",size = 16)  +
      goal_theme ()
...
ggplot(data=scores, aes(x=timeoc, y=score, group=Team)) +
    geom_step(data=wormA, aes(x=timeoc, y=score), colour = "blue", ,size=2) + 
    ...
    geom_text_repel(data = wormB, aes(x=timeoc, y=score, label = shotlab), size = 6, colour = "lightgreen",  
...
geom_text_repel(data = scores, aes(x=timeoc, y=scorediff, label = scrd),  size = 8) + 
 geom_vline(xintercept=39, linetype="dotted", color = "black") +
    annotate(geom="text", x=2, y=4.5, label="Cavan", color="blue", size = 16) +
    annotate(geom="text", x=3.5, y=-4.5, label="Donegal", color="lightgreen", size = 12) +
    theme(plot.background = element_blank(),
...
linksABs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/linkskocavdon.csv", header=TRUE, sep=";")
attach (linksABs)

nodesteamAko <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/nodeskocavdon.csv", header=TRUE, sep=";")
attach (nodesteamAko)
...
nodesteamBko <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/nodeskodoncav.csv", header=TRUE, sep=";")
attach (nodesteamBko)
...
kable (attstats)%>% kable_styling(bootstrap_options=c("striped",full_width = F))%>%column_spec(1,bold = T)%>%add_header_above(c(" "= 1, "Cavan" = 2, "Donegal" = 2))
...
linksABps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/passshotcavdon.csv", header=TRUE, sep=";")
attach (linksABps)

nodesteamAps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/nodesshotcavdon.csv", header=TRUE, sep=";")
attach (nodesteamAps)
...
nodesteamBps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/nodesshotdoncav.csv", header=TRUE, sep=";")
attach (nodesteamBps)
...
linksABs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/linksscorescavdon.csv", header=TRUE, sep=";")
attach (linksABps)

nodesteamAs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/nodesscorecavdon.csv", header=TRUE, sep=";")
attach (nodesteamAs)
...
nodesteamBs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/nodesscoredoncav.csv", header=TRUE, sep=";")
attach (nodesteamBs)
...
```{r, fig.width = 20, fig.height = 20}
linksAB <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/linkscavdon.csv", header=TRUE, sep=";")
attach (linksAB)

nodesteamA <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/nodescavdon.csv", header=TRUE, sep=";")
attach (nodesteamA)
...
nodesteamB <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/cavdon/nodesdoncav.csv", header=TRUE, sep=";")
attach (nodesteamB)
