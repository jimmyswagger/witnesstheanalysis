---
title: "Thomas Davis (0.09) vs Ballyboden (0.15)"
output:
  html_document:
    theme: cosmo
    toc: yes
...
Dublin Senior Football Championship Final - 2019
...
pass <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/passdavbod.csv", header=TRUE, sep=";")
attach (pass)

passline <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/passlinedavbod.csv", header=TRUE, sep=";")
attach (passline)

position  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/positiondavbod.csv", header=TRUE, sep=";")
attach (position)

plytree  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/plytreedavbod.csv", header=TRUE, sep=";")
attach (plytree)

plystats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/plystatsdavbod.csv", header=TRUE, sep=";")
attach (plystats)

passmap  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/passmapdavbod.csv", header=TRUE, sep=";")
attach (passmap)

scorelist  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/scorelistdavbod.csv", header=TRUE, sep=";")
attach (scorelist)

summary  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/summarydavbod.csv", header=TRUE, sep=";")
attach (summary)

scores  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/scoresdavbod.csv", header=TRUE, sep=";")
attach (scores)

scrd  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/scrddavbod.csv", header=TRUE, sep=";")
attach (scrd)

shots <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/shotsdavbod.csv", header=TRUE, sep=";")
attach (shots)

passtofrom  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/passtofromdavbod.csv", header=TRUE, sep=";")
attach (passtofrom)

attstats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/attstatsdavbod.csv", header=TRUE, sep=";")
attach (attstats)

origtime <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/origtimedavbod.csv", header=TRUE, sep=";")
attach (origtime)

shotstats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/shotstatsdavbod.csv", header=TRUE, sep=";")
attach (shotstats)

koeff <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/koeffdavbod.csv", header=TRUE, sep=";")
attach (koeff)

rseff <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/rseffdavbod.csv", header=TRUE, sep=";")
attach (rseff)

overview <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/overdavbod.csv", header=TRUE, sep=";")
attach (overview)

run <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/rundavbod.csv", header=TRUE, sep=";")
attach (run)
...
passbd<- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/passbddavbod.csv", header=TRUE, sep=";")
attach (passbd)
...
ggplot(overview, aes(x=Stat, y= Ballyboden)) + 
  geom_point(data = overview,aes(x=Stat, y=Thomas.Davis), col="lightgreen", size=10) +  
  geom_point(data = overview,aes(x=Stat, y=Ballyboden), col="blue", size= 10) +
  geom_segment(aes(x=Stat, xend=Stat, y=min(Thomas.Davis), yend=max(Thomas.Davis)), 
  linetype="dashed", size=0.1,colour = "grey") +     
  coord_flip() +
geom_text(data = overview,aes(x=Stat, y=Thomas.Davis,label = Thomas.Davis), size = 6,col="yellow") +
...
goal_theme <- function(){
  theme_classic() +
    theme(text = element_blank(),  
      ...
      annotate(geom="text", x= 1.50, y=3.5, label="Point - 9",color = "black",size = 14) + 
      annotate(geom="text", x= 2.50, y=3, label="Wide Right - 0",color = "black",size = 14) + 
      ...
      annotate(geom="text", x= 0.5, y=4.7, label="Thomas Davis",color = "black",size = 18)  +
      ...
      annotate(geom="text", x= 2, y=.5, label="Save/Blkd - 1/2",color = "black",size = 14) +
...
geom_text_repel(data = scores, aes(x=timeoc, y=scorediff, label = scrd),  size = 8) + 
 geom_vline(xintercept=35.5, linetype="dotted", color = "black") +
    annotate(geom="text", x=4, y=4.5, label="Thomas Davis", color="black", size = 12) +
...
###Kickout Network - Thomas Davis
```{r, fig.width = 20, fig.height = 20}

linksABs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/linkskodavbod.csv", header=TRUE, sep=";")
attach (linksABs)

nodesteamAko <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/nodeskodavbod.csv", header=TRUE, sep=";")
attach (nodesteamAko)
...
nodesteamBko <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/nodeskoboddav.csv", header=TRUE, sep=";")
attach (nodesteamBko)
...
kable (attstats)%>% kable_styling(bootstrap_options=c("striped",full_width = F))%>%column_spec(1,bold = T)%>%add_header_above(c(" "= 1, "Thomas Davis" = 2, "Ballyboden" = 2))
...
###Free Kick Shot Efficiency - Thomas Davis
```{r, fig.width = 16, fig.height = 10}
...
linksABps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/passshotdavbod.csv", header=TRUE, sep=";")
attach (linksABps)

nodesteamAps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/nodesshotdavbod.csv", header=TRUE, sep=";")
attach (nodesteamAps)
...
nodesteamBps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/nodesshotboddav.csv", header=TRUE, sep=";")
attach (nodesteamBps)
...
linksABs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/linksscoresdavbod.csv", header=TRUE, sep=";")
attach (linksABps)

nodesteamAs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/nodesscoredavbod.csv", header=TRUE, sep=";")
attach (nodesteamAs)
...
nodesteamBs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/nodesscoreboddav.csv", header=TRUE, sep=";")
attach (nodesteamBs)
...
```{r, fig.width = 20, fig.height = 20}
linksAB <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/linksdavbod.csv", header=TRUE, sep=";")
attach (linksAB)

nodesteamA <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/nodesdavbod.csv", header=TRUE, sep=";")
attach (nodesteamA)
...
nodesteamB <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/davbod/nodesboddav.csv", header=TRUE, sep=";")
attach (nodesteamB)
...
plot(netB, edge.arrow.size=.4, edge.color="blue",edge.arrow.width=.4,
