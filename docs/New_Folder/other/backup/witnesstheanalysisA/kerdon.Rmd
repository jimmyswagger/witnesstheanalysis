...
position  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/positionkerdon.csv", header=TRUE, sep=";")
attach (position)

plytree  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/plytreekerdon.csv", header=TRUE, sep=";")
attach (plytree)

plystats <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/plystatskerdon.csv", header=TRUE, sep=";")
attach (plystats)

passmap  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/passmapkerdon.csv", header=TRUE, sep=";")
attach (passmap)

scorelist  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/scorelistkerdon.csv", header=TRUE, sep=";")
attach (scorelist)

summary  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/summarykerdon.csv", header=TRUE, sep=";")
attach (summary)

scores  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/scoreskerdon.csv", header=TRUE, sep=";")
attach (scores)

scrd  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/scrdkerdon.csv", header=TRUE, sep=";")
attach (scrd)

shots <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/shotskerdon.csv", header=TRUE, sep=";")
attach (shots)
...
attstats <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/attstatskerdon.csv", header=TRUE, sep=";")
attach (attstats)

origtime <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/origtimekerdon.csv", header=TRUE, sep=";")
attach (origtime)

shotstats <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/shotstatskerdon.csv", header=TRUE, sep=";")
attach (shotstats)

koeff <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/koeffkerdon.csv", header=TRUE, sep=";")
attach (koeff)

overview <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/overkerdon.csv", header=TRUE, sep=";")
attach (overview)

run <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/runkerdon.csv", header=TRUE, sep=";")
attach (run)

tabrun <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/tabrun.csv", header=TRUE, sep=";")
attach (tabrun)

passbd<- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/passbdkerdon.csv", header=TRUE, sep=";")
attach (passbd)
...
linksABs <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/linkskokerdon.csv", header=TRUE, sep=";")
attach (linksABs)

nodesteamAko <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/nodeskokerdon.csv", header=TRUE, sep=";")
attach (nodesteamAko)
...
nodesteamBko <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/nodeskodonker.csv", header=TRUE, sep=";")
attach (nodesteamBko)
...
linksABps <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/passshotkerdon.csv", header=TRUE, sep=";")
attach (linksABps)

nodesteamAps <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/nodesshotkerdon.csv", header=TRUE, sep=";")
attach (nodesteamAps)
...
nodesteamBps <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/nodesshotdonker.csv", header=TRUE, sep=";")
attach (nodesteamBps)
...
linksABs <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/linksscoreskerdon.csv", header=TRUE, sep=";")
attach (linksABps)

nodesteamAs <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/nodesscorekerdon.csv", header=TRUE, sep=";")
attach (nodesteamAs)
...
nodesteamBs <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/nodesscoredonker.csv", header=TRUE, sep=";")
attach (nodesteamBs)
...
```{r, fig.width = 20, fig.height = 20}
linksAB <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/linkskerdon.csv", header=TRUE, sep=";")
attach (linksAB)

nodesteamA <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/nodeskerdon.csv", header=TRUE, sep=";")
attach (nodesteamA)
...
nodesteamB <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/kerdon/nodesdonker.csv", header=TRUE, sep=";")
attach (nodesteamB)
