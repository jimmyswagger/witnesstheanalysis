---
title: "Ballymun (0.14) vs Kilmacud Crokes (2.13)"
output:
  html_document:
    toc: true
    toc_float: true 
...
position  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/positionmuncrk.csv", header=TRUE, sep=";")
attach (position)

plytree  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/plytreemuncrk.csv", header=TRUE, sep=";")
attach (plytree)

plystats <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/plystatsmuncrk.csv", header=TRUE, sep=";")
attach (plystats)

passmap  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/passmapmuncrk.csv", header=TRUE, sep=";")
attach (passmap)

scorelist  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/scorelistmuncrk.csv", header=TRUE, sep=";")
attach (scorelist)

summary  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/summarymuncrk.csv", header=TRUE, sep=";")
attach (summary)

scores  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/scoresmuncrk.csv", header=TRUE, sep=";")
attach (scores)

scrd  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/scrdmuncrk.csv", header=TRUE, sep=";")
attach (scrd)

shots <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/shotsmuncrk.csv", header=TRUE, sep=";")
attach (shots)

passtofrom  <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/passtofrommuncrk.csv", header=TRUE, sep=";")
attach (passtofrom)

attstats <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/attstatsmuncrk.csv", header=TRUE, sep=";")
attach (attstats)

shotstats <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/shotstatsmuncrk.csv", header=TRUE, sep=";")
attach (shotstats)

koeff <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/koeffmuncrk.csv", header=TRUE, sep=";")
attach (koeff)

overview <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/overmuncrk.csv", header=TRUE, sep=";")
attach (overview)
...
# Plot
ggplot(overview, aes(x=Stat, y=Crokes)) + 
  geom_point(data = overview,aes(x=Stat, y=Ballymun), col="tomato2", size=10) +  
  geom_point(data = overview,aes(x=Stat, y=Crokes), col="purple", size= 10) +
  geom_segment(aes(x=Stat, xend=Stat, y=min(Crokes), yend=max(Crokes)), 
  linetype="dashed", size=0.1,colour = "grey") +     
  coord_flip() +
geom_text(data = overview,aes(x=Stat, y=Ballymun,label = Ballymun), size = 6,col="white") +
geom_text(data = overview,aes(x=Stat, y=Crokes,label = Crokes), size = 6,col="gold") +
my_theme ()
...
goal_theme <- function(){
  theme_classic() +
    theme(text = element_blank(),  
      ...
      annotate(geom="text", x= 1.50, y=1.5, label="Goal - 0",color = "white",size = 14) + 
      annotate(geom="text", x= 1.50, y=3.5, label="Point - 14",color = "white",size = 14) + 
      annotate(geom="text", x= 2.50, y=3, label="Wide Right - 1",color = "white",size = 14) + 
      annotate(geom="text", x= .50, y=3, label="Wide Left - 2",color = "white",size = 14) + 
      annotate(geom="text", x= 1, y=.5, label="Short - 4",color = "white",size = 14) + 
      annotate(geom="text", x= 2, y=.5, label="Save/Blkd - 1",color = "white",size = 14) +
      annotate(geom="text", x= 0.5, y=4.7, label="Ballymun",color = "white",size = 18)  +
      annotate(geom="text", x= 0.5, y=4.4, label="Total Shots - 22",color = "white",size = 16)  +
      goal_theme ()
      ...
      geom_segment(aes(x = 2, y = 1, xend = 2, yend = 4),colour = "white",linetype="solid",size = 3) +
      geom_segment(aes(x = 1, y = 2, xend = 2, yend = 2),colour = "white",linetype="solid",size = 3) +
      annotate(geom="text", x= 1.50, y=1.5, label="Goal - 2",color = "white",size = 14) + 
      annotate(geom="text", x= 1.50, y=3.5, label="Point - 13",color = "white",size = 14) + 
      annotate(geom="text", x= 2.50, y=3, label="Wide Right - 7",color = "white",size = 14) + 
      annotate(geom="text", x= .50, y=3, label="Wide Left - 4",color = "white",size = 14) + 
      annotate(geom="text", x= 1, y=.5, label="Short - 4",color = "white",size = 14) + 
      annotate(geom="text", x= 2, y=.5, label="Save/Blkd - 3",color = "white",size = 14) +
      annotate(geom="text", x= 0.5, y=4.7, label="Crokes",color = "white",size = 18)  +
      annotate(geom="text", x= 0.5, y=4.4, label="Total Shots - 35",color = "white",size = 16)  +
      goal_theme ()
...
p + geom_point(data = positionB, aes(x=Areax, y=Areay, shape = Team), colour = "purple",size = 6) +
  theme(plot.title = element_text( size=32, hjust=0)) +
...
ggplot(data=scores, aes(x=timeoc, y=score, group=Team)) +
    ...
    geom_step(data=wormB, aes(x=timeoc, y=score), colour = "gold", size=2) + 
    geom_point(data = wormA, shape = 1, size = 4, stroke = 2, colour = "red") +
    geom_point(data = wormB, shape = 1, size = 4, stroke = 2, colour = "purple") +
    theme_classic() + 
    ...
    geom_text_repel(data = wormB, aes(x=timeoc, y=score, label = shotlab), size = 6, colour = "purple",  
   ...
   geom_vline(xintercept=64, linetype="dotted", color = "black") +  
      ...
      annotate(geom="text", x= 64, y=-0.25, label="FT",color = "black") +
...
geom_vline(xintercept=15, linetype="dotted", color = "black") +
 ...
 geom_vline(xintercept=45, linetype="dotted", color = "black") + 
 geom_vline(xintercept=64, linetype="dotted", color = "black") +
    annotate(geom="text", x=2, y=4.5, label="Ballymun", color="red", size = 16) +
    annotate(geom="text", x=1.5, y=-4.5, label="Crokes", color="purple", size = 16) +
    theme(plot.background = element_blank(),
...
sp + geom_text(data= koeffA, aes(x= tx, y= ty, label = Recd),colour = "blue", size = 9) +
geom_text(data= koeffA, aes(x= bx, y= by, label = Rec),colour = "blue", size = 7)
```

##Kickout Network - Ballymun
```{r, fig.width = 20, fig.height = 20}

linksABs <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/linkskomuncrk.csv", header=TRUE, sep=";")
attach (linksABs)

nodesteamAko <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/nodeskomuncrk.csv", header=TRUE, sep=";")
attach (nodesteamAko)
...
sp + geom_text(data= koeffB, aes(x= tx, y= ty, label = Recd),colour = "blue", size = 9) +
geom_text(data= koeffB, aes(x= bx, y= by, label = Rec),colour = "blue", size = 7)
```
...
nodesteamBko <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/nodeskocrkmun.csv", header=TRUE, sep=";")
attach (nodesteamBko)
...
# Generate colors based on number of position (ie gk back mf for) type:
colrs <- c("purple", "purple", "purple","purple","purple")
...
plot(netBko, edge.arrow.size=.4, edge.color="gold",edge.arrow.width=.4,
      edge.width=E(netBko)$weight*5, layout=as.matrix(nodes.coordB[,c("x","y")]), vertex.label.color="gold",  vertex.label = labkoB, vertex.label.cex = 5)
...
scale_shape_manual(values=c(15, 16,17)) +
    scale_color_manual(values=c("white","white","blue"))
```
...
FKLB <- pass %>%group_by(Team, Action) %>% filter(Teamnum == "B", subset =="Fkws"|subset =="Fkwns"| Action == "Free Won Def")%>%summarize(count=n())
...
scale_shape_manual(values=c(15, 16, 17,18)) +
    scale_color_manual(values=c("blue","white","white","white"))
```
...
```{r, fig.width = 20, fig.height = 20}
linksAB <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/linksmuncrk.csv", header=TRUE, sep=";")
attach (linksAB)

nodesteamA <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/nodesmuncrk.csv", header=TRUE, sep=";")
attach (nodesteamA)
...
linksAB <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayker/linksmayker.csv", header=TRUE, sep=";")
attach (linksAB)


nodesteamB <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayker/nodeskermay.csv", header=TRUE, sep=";")
attach (nodesteamB)
...
# Generate colors based on number of position (ie gk back mf for) type:
colrs <- c("purple", "purple", "purple", "purple")
...
```{r}
ggplot(data = plystats , aes(x = plytime, y = NoP)) + 
geom_point(data = plystats , aes(x = plytime, y = NoP, colour = Team), size =2) +
geom_text_repel(data = plystats , aes(x = plytime, y = NoP, colour = Team, label = ply), size = 4) +
theme_classic () +
guides(size = FALSE) + 
  theme(legend.position="bottom")
```
...
##Score Network - Ballymun
```{r, fig.width = 20, fig.height = 20}

linksABs <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/linksscoresmuncrk.csv", header=TRUE, sep=";")
attach (linksABps)

nodesteamAs <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/nodesscoremuncrk.csv", header=TRUE, sep=";")
attach (nodesteamAs)
...
nodesteamBs <- read.csv(file="c:/Users/donag/OneDrive/Spreadsheet fun/PA Analytics/PA Template/muncrk/nodesscorecrkmun.csv", header=TRUE, sep=";")
attach (nodesteamBs)
...
# Generate colors based on number of position (ie gk back mf for) type:
colrs <- c("purple", "tomato", "tomato","tomato","tomato")
...
plot(netBs, edge.arrow.size=.4, edge.color="gold",edge.arrow.width=.4,
      edge.width=E(netBs)$weight*5, layout=as.matrix(nodes.coordB[,c("x","y")]), vertex.label.color="gold",  vertex.label = labBscr, vertex.label.cex = 5)
