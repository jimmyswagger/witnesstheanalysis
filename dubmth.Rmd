...
pass <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/passdubmth.csv", header=TRUE, sep=";")
attach (pass)

position  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/positiondubmth.csv", header=TRUE, sep=";")
attach (position)

plytree  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/plytreedubmth.csv", header=TRUE, sep=";")
attach (plytree)

plystats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/plystatsdubmth.csv", header=TRUE, sep=";")
attach (plystats)

passmap  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/passmapdubmth.csv", header=TRUE, sep=";")
attach (passmap)

scorelist  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/scorelistdubmth.csv", header=TRUE, sep=";")
attach (scorelist)

summary  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/summarydubmth.csv", header=TRUE, sep=";")
attach (summary)

scores  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/scoresdubmth.csv", header=TRUE, sep=";")
attach (scores)

scrd  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/scrddubmth.csv", header=TRUE, sep=";")
attach (scrd)

shots <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/shotsdubmth.csv", header=TRUE, sep=";")
attach (shots)

passtofrom  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/passtofromdubmth.csv", header=TRUE, sep=";")
attach (passtofrom)

attstats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/attstatsdubmth.csv", header=TRUE, sep=";")
attach (attstats)

origtime <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/origtimedubmth.csv", header=TRUE, sep=";")
attach (origtime)

shotstats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/shotstatsdubmth.csv", header=TRUE, sep=";")
attach (shotstats)

koeff <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/koeffdubmth.csv", header=TRUE, sep=";")
attach (koeff)

overview <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/overdubmth.csv", header=TRUE, sep=";")
attach (overview)

run <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/rundubmth.csv", header=TRUE, sep=";")
attach (run)
...
# Plot
ggplot(overview, aes(x=Stat, y=Dublin)) + 
  geom_point(data = overview,aes(x=Stat, y=Dublin), col="darkblue", size=10) +  
  geom_point(data = overview,aes(x=Stat, y=Meath), col="lightgreen", size= 10) +
  geom_segment(aes(x=Stat, xend=Stat, y=min(Dublin), yend=max(Dublin)), 
...
goal_theme <- function(){
  theme_classic() +
    theme(text = element_blank(),  
      ...
      annotate(geom="text", x= 1, y=.5, label="Short/Post - 1/1",color = "black",size = 14) + 
      annotate(geom="text", x= 2, y=.5, label="Save/Blkd - 0/2",color = "black",size = 14) +
      annotate(geom="text", x= 0.5, y=4.7, label="Dublin",color = "black",size = 18)  +
      ...
      annotate(geom="text", x= 1.50, y=3.5, label="Point - 4",color = "black",size = 14) + 
      ...
      annotate(geom="text", x= 1, y=.5, label="Short/Post - 5/3",color = "black",size = 14) + 
      annotate(geom="text", x= 2, y=.5, label="Save/Blkd - 0/1",color = "black",size = 14) +
      annotate(geom="text", x= 0.5, y=4.7, label="Meath",color = "black",size = 18)  +
      annotate(geom="text", x= 0.5, y=4.4, label="Total Shots - 22",color = "black",size = 16)  +
      goal_theme ()
...
ggplot(data=scores, aes(x=timeoc, y=score, group=Team)) +
    ...
    axis.title.x = element_blank()) +
    geom_text_repel(data = wormA, aes(x=timeoc, y=score, label = shotlab), size = 6, colour = "darkblue",  
    ...
    segment.size  = 0.2,  direction = "y", hjust = 1,nudge_x = 2, nudge_y = 2) + 
    guides(size = FALSE) +
...
linksABs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/linkskodubmth.csv", header=TRUE, sep=";")
attach (linksABs)

nodesteamAko <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/nodeskodubmth.csv", header=TRUE, sep=";")
attach (nodesteamAko)
...
plot(netAko, edge.arrow.size=.4, edge.color="darkblue",edge.arrow.width=.4,
      edge.width=E(netAko)$weight*5, layout=as.matrix(nodes.coordA[,c("x","y")]), vertex.label.color="lightblue", vertex.label = labkoA, vertex.label.cex = 5)
...
nodesteamBko <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/nodeskomthdub.csv", header=TRUE, sep=";")
attach (nodesteamBko)
...
kable (attstats)%>% kable_styling(bootstrap_options=c("striped",full_width = F))%>%column_spec(1,bold = T)%>%add_header_above(c(" "= 1, "Dublin" = 2, "Meath" = 2))
...
linksABps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/passshotdubmth.csv", header=TRUE, sep=";")
attach (linksABps)

nodesteamAps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/nodesshotdubmth.csv", header=TRUE, sep=";")
attach (nodesteamAps)
...
plot(netAps, edge.arrow.size=.4, edge.color="lightblue",edge.arrow.width=.4,
      edge.width=E(netAps)$weight*5, layout=as.matrix(nodes.coordA[,c("x","y")]), vertex.label.color="lightblue", vertex.label = labelAsh, vertex.label.cex = 5)
```
...
nodesteamBps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/nodesshotmthdub.csv", header=TRUE, sep=";")
attach (nodesteamBps)
...
linksABs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/linksscoresdubmth.csv", header=TRUE, sep=";")
attach (linksABps)

nodesteamAs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/nodesscoredubmth.csv", header=TRUE, sep=";")
attach (nodesteamAs)
...
plot(netAs, edge.arrow.size=.4, edge.color="lightblue",edge.arrow.width=.4,
      edge.width=E(netAs)$weight*5, layout=as.matrix(nodes.coordA[,c("x","y")]), vertex.label.color="lightblue", vertex.label = labAscr, vertex.label.cex = 5)
...
nodesteamBs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/nodesscoremthdub.csv", header=TRUE, sep=";")
attach (nodesteamBs)
...
```{r, fig.width = 20, fig.height = 20}
linksAB <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/linksdubmth.csv", header=TRUE, sep=";")
attach (linksAB)

nodesteamA <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/nodesdubmth.csv", header=TRUE, sep=";")
attach (nodesteamA)
...
plot(netA, edge.arrow.size=.4, edge.color="lightblue",edge.arrow.width=.4,
      edge.width=E(netA)$weight*5, layout=as.matrix(nodes.coordA[,c("x","y")]), vertex.label.color="lightblue", vertex.label = labelA, vertex.label.cex = 5)
```
...
nodesteamB <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/dubmth/nodesmthdub.csv", header=TRUE, sep=";")
attach (nodesteamB)
