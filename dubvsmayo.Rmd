...
pass <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/DubvsMayo/gamelogdubmayo.csv", header=TRUE, sep=";")
attach (pass)

position  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/DubvsMayo/positiondubmayo.csv", header=TRUE, sep=";")
attach (position)

scorelist  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/DubvsMayo/scorelistdubmayo.csv", header=TRUE, sep=";")
attach (scorelist)

summary  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/DubvsMayo/summarydubmayo.csv", header=TRUE, sep=";")
attach (summary)

scores  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/DubvsMayo/scoresdubmayo.csv", header=TRUE, sep=";")
attach (scores)

passtofrom  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/DubvsMayo/passtofromdubmayo.csv", header=TRUE, sep=";")
attach (passtofrom)

passmap  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/DubvsMayo/passmapdubmayo.csv", header=TRUE, sep=";")
attach (passmap)

scrd  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/DubvsMayo/shotvertdubmayo.csv", header=TRUE, sep=";")
attach (scrd)

plytree  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/DubvsMayo/plytreedubmayo.csv", header=TRUE, sep=";")
attach (plytree)

linksAB <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/DubvsMayo/linksdubmayo.csv", header=TRUE, sep=";")
attach (linksAB)

nodesteamA <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/DubvsMayo/nodesdubmayo.csv", header=TRUE, sep=";")
attach (nodesteamA)

nodesteamB <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/DubvsMayo/nodesmayodub.csv", header=TRUE, sep=";")
attach (nodesteamB)

plystats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/DubvsMayo/plystatsdubmayo.csv", header=TRUE, sep=";")
attach (plystats)
...
p + geom_point(data = positionA, aes(x=Areax, y=Areay, shape = Team), colour = "darkblue",size = 6) +
  theme(plot.title = element_text( size=32, hjust=0)) +
  geom_text_repel(data = positionA, aes(x=Areax, y=Areay, label = Player), colour = "darkblue", size = 8) +
...
p + geom_point(data = positionB, aes(x=Areax, y=Areay, shape = Team), colour = "red",size = 6) +
  theme(plot.title = element_text( size=32, hjust=0)) +
  geom_text_repel(data = positionB, aes(x=Areax, y=Areay, label = Player), colour = "red", size = 8) +
  theme(legend.position="none")
...
#Average Position by Touch
##Dublin

```{r, fig.width = 16, fig.height = 10}

aveposA <- pass %>% group_by(Player, Action) %>% filter(Teamnum == "A", Action== "Tack W"| Action== "KP Int"|Action== "HP Int"|Action== "Kp Brk Int"|Action== "Hp Brk Int"|
...
p + geom_point(data = avgposA, aes(x=AreaxA, y=AreayA), colour = "darkblue", size = 6) +
...
##Mayo
```{r, fig.width = 16, fig.height = 10}
aveposB <- pass %>% group_by(Player, Action) %>% filter(Teamnum == "B", Action== "Tack W"| Action== "KP Int"|Action== "HP Int"|Action== "Kp Brk Int"|Action== "Hp Brk Int"|
Action== "Kp Free Int"|Action== "Fk Brk Int"|Action== "Mk Kp Int"|Action== "Sl Int"|
Action== "Sl Brk Int"|Action== "Ko Int"|Action== "KoBrk Int"|Action== "Ko Int Mk"|
Action== "Fk Short Gk"|Action== "Short Gk"|Action== "Loose TBW"|Action== "Free Won Def"|
Action== "Sl Kp Won To"|Action== "Rebnd Def"|Action== "Rebnd Off"|Action== "Loss BW"|
...
#Areas of Play by Touch
##Dublin
```{r, fig.width = 16, fig.height = 10}
heatmapA <- passmap %>%filter(plyr == "A")


p + geom_raster(data = heatmapA, aes(x=Areax, y=Areay, fill=value, alpha = value), interpolate = F) +
scale_fill_gradient(low = "gray95", high = "lightblue") + 
 theme(legend.position="none")
```
...
p + geom_path(data = A1, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A2, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A3, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A4, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A5, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A6, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A7, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A8, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A9, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A10, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A11, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A12, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A13, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A14, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A15, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A16, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A17, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A18, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A19, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A20, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A21, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A22, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A23, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A24, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A25, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A26, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A27, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A28, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A29, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A30, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A31, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A32, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A33, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A34, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A35, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A36, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A37, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A38, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A39, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A40, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A41, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A42, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A43, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A44, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A45, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A46, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") + 
geom_path(data = A47, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") +
geom_path(data = A48, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") +
geom_path(data = A49, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") +
geom_path(data = A50, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue") +
geom_path(data = A51, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "darkblue")   
...
p + geom_path(data = B1, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B2, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B3, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B4, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B5, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B6, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B7, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B8, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B9, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B10, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B11, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B12, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B13, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B14, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B15, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B16, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B17, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B18, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B19, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B20, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B21, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B22, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B23, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B24, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B25, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B26, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B27, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B28, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B29, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B30, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B31, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B32, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B33, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B34, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B35, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B36, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B37, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B38, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B39, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B40, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B41, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B42, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B43, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B44, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B45, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B46, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B47, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B48, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") + 
geom_path(data = B49, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") +
geom_path(data = B50, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") +
geom_path(data = B51, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") +  
geom_path(data = B52, aes(x=Areax, y=Areay), size = 0.4, linetype="dotted", colour = "red") 
```
...
Action == "Hp Brk Int"|Action == "Kp Free Int"|Action == "Fk Brk Int"|
Action == "Mk Kp Int"|Action == "Sl Int"|Action == "Sl Brk Int"|
Action == "Ko Int"|Action == "KoBrk Int"|Action == "Ko Int Mk"|
Action == "Fk Short Gk"|Action == "Short Gk"|Action == "Loose TBW"|Action == "Free Won Def"|
Action == "Sl Kp Won To"|Action == "Rebnd Def"|Action == "Rebnd Off"|Action == "Loss BW"|
Action == "Brk Won"|Action == "Loose RBW")

TeamAphasePAMicq <- TeamAPAMi %>% filter(Action== "Tack W"| Action== "KP Int"|Action== "HP Int"|Action== "Kp Brk Int"|Action== "Hp Brk Int"|
Action== "Kp Free Int"|Action== "Fk Brk Int"|Action== "Mk Kp Int"|Action== "Sl Int"|
Action== "Sl Brk Int"|Action== "Ko Int"|Action== "KoBrk Int"|Action== "Ko Int Mk"|
Action== "Fk Short Gk"|Action== "Short Gk"|Action== "Loose TBW"|Action== "Free Won Def"|
Action== "Sl Kp Won To"|Action== "Rebnd Def"|Action== "Loss BW"|
Action== "Brk Won")
...
#Ones that start from turnover
TeamBphasePASccq <- TeamBPASc %>% filter(Action == "Tack W"|Action == "KP Int"|Action == "HP Int"|Action == "Kp Brk Int"|
Action == "Hp Brk Int"|Action == "Kp Free Int"|Action == "Fk Brk Int"|
Action == "Mk Kp Int"|Action == "Sl Int"|Action == "Sl Brk Int"|
Action == "Ko Int"|Action == "KoBrk Int"|Action == "Ko Int Mk"|
Action == "Fk Short Gk"|Action == "Short Gk"|Action == "Loose TBW"|Action == "Free Won Def"|
...
TeamBphasePAMicq <- TeamBPAMi %>% filter(Action== "Tack W"| Action== "KP Int"|Action== "HP Int"|Action== "Kp Brk Int"|Action== "Hp Brk Int"|
Action== "Kp Free Int"|Action== "Fk Brk Int"|Action== "Mk Kp Int"|Action== "Sl Int"|
Action== "Sl Brk Int"|Action== "Ko Int"|Action== "KoBrk Int"|Action== "Ko Int Mk"|
Action== "Fk Short Gk"|Action== "Short Gk"|Action== "Loose TBW"|Action== "Free Won Def"|
Action== "Sl Kp Won To"|Action== "Rebnd Def"|Action== "Loss BW"|
...
TeamBphasePAScko <- TeamBPASc %>% filter(Action=="Ko Rec"|Action=="KoBrk Rec"|Action =="Ko Unc Rec"|Action =="Ko Mk Won")

TeamBphasePAMiko <- TeamBPAMi %>% filter(Action=="Ko Rec"|Action=="KoBrk Rec"|Action =="Ko Unc Rec"|Action =="Ko Mk Won")
...
#Score
TeamAphasecq <- TeamAPhASc %>% filter(Action == "Tack W"|Action == "KP Int"|Action == "HP Int"|Action == "Kp Brk Int"|
Action == "Hp Brk Int"|Action == "Kp Free Int"|Action == "Fk Brk Int"|
Action == "Mk Kp Int"|Action == "Sl Int"|Action == "Sl Brk Int"|
Action == "Ko Int"|Action == "KoBrk Int"|Action == "Ko Int Mk"|
Action == "Fk Short Gk"|Action == "Short Gk"|Action == "Loose TBW"|Action == "Free Won Def"|
...
TeamAphaseko <- TeamAPhASc %>% filter(Action=="Ko Rec"|Action=="KoBrk Rec"|Action =="Ko Unc Rec"|Action =="Ko Mk Won")

#Add in Miss
TeamAphasecqMi <- TeamAPhAMi %>% filter(Action == "Tack W"|Action == "KP Int"|Action == "HP Int"|Action == "Kp Brk Int"|
Action == "Hp Brk Int"|Action == "Kp Free Int"|Action == "Fk Brk Int"|
Action == "Mk Kp Int"|Action == "Sl Int"|Action == "Sl Brk Int"|
Action == "Ko Int"|Action == "KoBrk Int"|Action == "Ko Int Mk"|
Action == "Fk Short Gk"|Action == "Short Gk"|Action == "Loose TBW"|Action == "Free Won Def"|
...
TeamAphasekoMi <- TeamAPhAMi %>% filter(Action=="Ko Rec"|Action=="KoBrk Rec"|Action =="Ko Unc Rec"|Action =="Ko Mk Won")
...
#Score
TeamBphasecq <- TeamBPhASc %>% filter(Action == "Tack W"|Action == "KP Int"|Action == "HP Int"|Action == "Kp Brk Int"|
Action == "Hp Brk Int"|Action == "Kp Free Int"|Action == "Fk Brk Int"|
Action == "Mk Kp Int"|Action == "Sl Int"|Action == "Sl Brk Int"|
Action == "Ko Int"|Action == "KoBrk Int"|Action == "Ko Int Mk"|
Action == "Fk Short Gk"|Action == "Short Gk"|Action == "Loose TBW"|Action == "Free Won Def"|
...
TeamBphaseko <- TeamBPhASc %>% filter(Action=="Ko Rec"|Action=="KoBrk Rec"|Action =="Ko Unc Rec"|Action =="Ko Mk Won")

#Add in Miss
TeamBphasecqMi <- TeamBPhAMi %>% filter(Action == "Tack W"|Action == "KP Int"|Action == "HP Int"|Action == "Kp Brk Int"|
Action == "Hp Brk Int"|Action == "Kp Free Int"|Action == "Fk Brk Int"|
Action == "Mk Kp Int"|Action == "Sl Int"|Action == "Sl Brk Int"|
Action == "Ko Int"|Action == "KoBrk Int"|Action == "Ko Int Mk"|
Action == "Fk Short Gk"|Action == "Short Gk"|Action == "Loose TBW"|Action == "Free Won Def"|
...
TeamBphasekoMi <- TeamBPhAMi %>% filter(Action=="Ko Rec"|Action=="KoBrk Rec"|Action =="Ko Unc Rec"|Action =="Ko Mk Won")
...
#Map Team A
komapA <-filter(pass, Teamnum == "A",Action=="Ko Rec"| Action =="Ko Lost"|Action=="KoBrk Rec"|Action=="KoBrk Lost"|Action =="Ko Mk Won"|Action =="Ko Lost Mk"|Action =="Ko Unc Rec")
...
#Map Team B
komapB <-filter(pass, Teamnum == "B", Action=="Ko Rec"| Action =="Ko Lost"|Action=="KoBrk Rec"|Action=="KoBrk Lost"|Action =="Ko Mk Won"|Action =="Ko Lost Mk"|Action =="Ko Unc Rec")
...
```{r, fig.width = 16, fig.height = 10}
conqmapA <- filter(pass, Teamnum == "A", Action== "Tack W"| Action== "KP Int"|Action== "HP Int"|Action== "Kp Brk Int"|Action== "Hp Brk Int"|
Action== "Kp Free Int"|Action== "Fk Brk Int"|Action== "Mk Kp Int"|Action== "Sl Int"|
Action== "Sl Brk Int"|Action== "Ko Int"|Action== "KoBrk Int"|Action== "Ko Int Mk"|
Action== "Fk Short Gk"|Action== "Short Gk"|Action== "Loose TBW"|Action== "Free Won Def"|
Action== "Sl Kp Won To"|Action== "Rebnd Def"|Action== "Loss BW")
...
##Mayo
```{r, fig.width = 16, fig.height = 10}
conqmapB <-filter(pass, Teamnum == "B", Action== "Tack W"| Action== "KP Int"|Action== "HP Int"|Action== "Kp Brk Int"|Action== "Hp Brk Int"|
Action== "Kp Free Int"|Action== "Fk Brk Int"|Action== "Mk Kp Int"|Action== "Sl Int"|
Action== "Sl Brk Int"|Action== "Ko Int"|Action== "KoBrk Int"|Action== "Ko Int Mk"|
Action== "Fk Short Gk"|Action== "Short Gk"|Action== "Loose TBW"|Action== "Free Won Def"|
Action== "Sl Kp Won To"|Action== "Rebnd Def"|Action== "Loss BW")
...
passA <- passtofrom %>% filter(Teamnum == "A" ,octype =="Hp Rec"| octype =="Kp Rec"|octype == "Loss")
...
p + geom_segment(data = passA, aes(x = Areax, y = Areay, xend = xend, yend = yend, colour = octype)) +
    ...
    scale_shape_manual(values=c(0, 2, 1, 5, 4,8,9,10)) +
...
passB <- passtofrom %>% filter(Teamnum == "B" ,octype =="Hp Rec"| octype =="Kp Rec"|octype == "Loss")

p + geom_segment(data = passB, aes(x = Areax, y = Areay, xend = xend, yend = yend, colour = octype)) +
    geom_point(data = passB, aes(x = Areax, y = Areay, colour = octype, shape = Action, size = 1,stroke = 2)) +
    geom_point (data = passB, aes(x=xend, y=yend, colour = octype, shape = octype, size = 1,stroke = 2)) +   
    scale_shape_manual(values=c(0, 2, 1, 5, 8,4,9,10)) +
    scale_color_manual(values=c("white","blue","red"))  +
...
#passing to from
advpassA <- passtofrom %>% filter(Areax <5.5 & xend > 5.5 , Teamnum == "A" ,octype =="Hp Rec"| octype =="Kp Rec"|octype == "Loss")

p + geom_segment(data = advpassA, aes(x = Areax, y = Areay, xend = xend, yend = yend, colour = octype)) +
    geom_point(data = advpassA, aes(x = Areax, y = Areay, colour = octype, shape = Action, size = 1,stroke = 2)) +
    geom_point (data = advpassA, aes(x=xend, y=yend, colour = octype, shape = octype, size = 1,stroke = 2)) +   
    scale_shape_manual(values=c(0, 2, 1, 5, 4,8,9)) +
    scale_color_manual(values=c("white","blue","red"))  +
    theme(legend.position="bottom", legend.title=element_text(size=18), 
          legend.text=element_text(size=20)) +
    guides(color = FALSE, size = FALSE) +
...
##Mayo
```{r, fig.width = 16, fig.height = 10}
advpassB <- passtofrom %>% filter(Areax <5.5 & xend > 5.5 , Teamnum == "B" ,octype =="Hp Rec"| octype =="Kp Rec"|octype == "Loss")

p + geom_segment(data = advpassB, aes(x = Areax, y = Areay, xend = xend, yend = yend, colour = octype)) +
    geom_point(data = advpassB, aes(x = Areax, y = Areay, colour = octype, shape = Action, size = 1,stroke = 2)) +
    geom_point (data = advpassB, aes(x=xend, y=yend, colour = octype, shape = octype, size = 1,stroke = 2)) +   
    scale_shape_manual(values=c(0, 2, 1, 5, 4,8,9)) +
    scale_color_manual(values=c("white","blue","red"))  +
    theme(legend.position="bottom", legend.title=element_text(size=18), 
          legend.text=element_text(size=20)) +
...
colrs <- c("darkblue", "darkblue", "darkblue", "darkblue")
...
plot(netA, edge.arrow.size=.4, edge.color="lightblue",edge.arrow.width=.4,
      edge.width=E(netA)$weight*5, layout=as.matrix(nodes.coordA[,c("x","y")]), vertex.label.color="lightblue", vertex.label = labeldub, vertex.label.cex = 5)
...
# Generate colors based on number of position (ie gk back mf for) type:
colrs <- c("tomato", "tomato", "tomato", "tomato")
...
plot(netB, edge.arrow.size=.4, edge.color="lightgreen",edge.arrow.width=.4,
      edge.width=E(netB)$weight*5, layout=as.matrix(nodes.coordB[,c("x","y")]), vertex.label.color="lightgreen",  vertex.label = labelmayo, vertex.label.cex = 5)
