...
pass <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/passgalros.csv", header=TRUE, sep=";")
attach (pass)

position  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/positiongalros.csv", header=TRUE, sep=";")
attach (position)

plytree  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/plytreegalros.csv", header=TRUE, sep=";")
attach (plytree)

plystats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/plystatsgalros.csv", header=TRUE, sep=";")
attach (plystats)

passmap  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/passmapgalros.csv", header=TRUE, sep=";")
attach (passmap)

scorelist  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/scorelistgalros.csv", header=TRUE, sep=";")
attach (scorelist)

summary  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/summarygalros.csv", header=TRUE, sep=";")
attach (summary)

scores  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/scoresgalros.csv", header=TRUE, sep=";")
attach (scores)

scrd  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/scrdgalros.csv", header=TRUE, sep=";")
attach (scrd)

shots <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/shotsgalros.csv", header=TRUE, sep=";")
attach (shots)

passtofrom  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/passtofromgalros.csv", header=TRUE, sep=";")
attach (passtofrom)

attstats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/attstatsgalros.csv", header=TRUE, sep=";")
attach (attstats)

origtime <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/origtimegalros.csv", header=TRUE, sep=";")
attach (origtime)

shotstats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/shotstatsgalros.csv", header=TRUE, sep=";")
attach (shotstats)

koeff <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/koeffgalros.csv", header=TRUE, sep=";")
attach (koeff)

overview <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/overgalros.csv", header=TRUE, sep=";")
attach (overview)

run <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/rungalros.csv", header=TRUE, sep=";")
attach (run)
...
p + geom_point(data = positionA, aes(x=Areax, y=Areay, shape = Team), colour = "darkred",size = 6) +
...
# Plot
ggplot(overview, aes(x=Stat, y=Galway)) + 
  geom_point(data = overview,aes(x=Stat, y=Galway), col="darkred", size=10) +  
  geom_point(data = overview,aes(x=Stat, y=Roscommon), col="blue", size= 10) +
  geom_segment(aes(x=Stat, xend=Stat, y=min(Galway), yend=max(Galway)), 
  linetype="dashed", size=0.1,colour = "grey") +     
  coord_flip() +
geom_text(data = overview,aes(x=Stat, y=Galway,label = Galway), size = 6,col="white") +
...
goal_theme <- function(){
  theme_classic() +
    theme(text = element_blank(),  
      ...
      annotate(geom="text", x= 1, y=.5, label="Short/Post - 0/1",color = "black",size = 14) + 
      annotate(geom="text", x= 2, y=.5, label="Save/Blkd - 1/0",color = "black",size = 14) +
      annotate(geom="text", x= 0.5, y=4.7, label="Galway",color = "black",size = 18)  +
      annotate(geom="text", x= 0.5, y=4.4, label="Total Shots - 19",color = "black",size = 16)  +
      goal_theme ()
      ...
      annotate(geom="text", x= 2, y=.5, label="Save/Blkd - 0/0",color = "black",size = 14) +
      annotate(geom="text", x= 0.5, y=4.7, label="Roscommon",color = "black",size = 18)  +
      annotate(geom="text", x= 0.5, y=4.4, label="Total Shots - 20",color = "black",size = 16)  +
      goal_theme ()
...
ggplot(data=scores, aes(x=timeoc, y=score, group=Team)) +
    geom_step(data=wormA, aes(x=timeoc, y=score), colour = "darkred", ,size=2) + 
    geom_step(data=wormB, aes(x=timeoc, y=score), colour = "yellow", size=2) + 
    geom_point(data = wormA, shape = 1, size = 4, stroke = 2, colour = "black") +
    ...
    axis.title.x = element_blank()) +
    geom_text_repel(data = wormA, aes(x=timeoc, y=score, label = shotlab), size = 6, colour = "black",  
...
geom_vline(xintercept=17.5, linetype="dotted", color = "black") +
 ...
 geom_vline(xintercept=75, linetype="dotted", color = "black") +
    annotate(geom="text", x=2, y=4.5, label="Galway", color="darkred", size = 16) +
...
p + geom_point(data = avgposA, aes(x=AreaxA, y=AreayA), colour = "darkred", size = 6) +
...
linksABs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/linkskogalros.csv", header=TRUE, sep=";")
attach (linksABs)

nodesteamAko <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/nodeskogalros.csv", header=TRUE, sep=";")
attach (nodesteamAko)
...
colrs <- c("black", "black", "black", "black", "black")
...
plot(netAko, edge.arrow.size=.4, edge.color="black",edge.arrow.width=.4,
      edge.width=E(netAko)$weight*5, layout=as.matrix(nodes.coordA[,c("x","y")]), vertex.label.color="darkred", vertex.label = labkoA, vertex.label.cex = 5)
...
nodesteamBko <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/nodeskorosgal.csv", header=TRUE, sep=";")
attach (nodesteamBko)
...
total_FKB <- paste0("Total Fk Loss: ",
                      format(sum(final_data$count), big.mark = ","))
...
kable (attstats)%>% kable_styling(bootstrap_options=c("striped",full_width = F))%>%column_spec(1,bold = T)%>%add_header_above(c(" "= 1, "Galway" = 2, "Roscommon" = 2))
...
linksABps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/passshotgalros.csv", header=TRUE, sep=";")
attach (linksABps)

nodesteamAps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/nodesshotgalros.csv", header=TRUE, sep=";")
attach (nodesteamAps)
...
# Generate colors based on number of position (ie gk back mf for) type:
colrs <- c("darkred", "darkred", "darkred", "darkred", "darkred")
...
nodesteamBps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/nodesshotrosgal.csv", header=TRUE, sep=";")
attach (nodesteamBps)
...
linksABs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/linksscoresgalros.csv", header=TRUE, sep=";")
attach (linksABps)

nodesteamAs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/nodesscoregalros.csv", header=TRUE, sep=";")
attach (nodesteamAs)
...
# Generate colors based on number of position (ie gk back mf for) type:
colrs <- c("black", "lightgreen", "lightgreen", "lightgreen", "lightgreen")
...
plot(netAs, edge.arrow.size=.4, edge.color="darkred",edge.arrow.width=.4,
      edge.width=E(netAs)$weight*5, layout=as.matrix(nodes.coordA[,c("x","y")]), vertex.label.color="darkred", vertex.label = labAscr, vertex.label.cex = 5)
...
nodesteamBs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/nodesscorerosgal.csv", header=TRUE, sep=";")
attach (nodesteamBs)
...
```{r, fig.width = 20, fig.height = 20}
linksAB <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/linksgalros.csv", header=TRUE, sep=";")
attach (linksAB)

nodesteamA <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/nodesgalros.csv", header=TRUE, sep=";")
attach (nodesteamA)
...
nodesteamB <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/galros/nodesrosgal.csv", header=TRUE, sep=";")
attach (nodesteamB)
