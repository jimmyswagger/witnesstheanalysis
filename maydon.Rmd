---
title: "Mayo (1.14) vs Donegal (1.10)"
output:
  html_document:
    toc: true
    toc_float: true 
...
pass <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/passmaydon.csv", header=TRUE, sep=";")
attach (pass)

position  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/positionmaydon.csv", header=TRUE, sep=";")
attach (position)

plytree  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/plytreemaydon.csv", header=TRUE, sep=";")
attach (plytree)

plystats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/plystatsmaydon.csv", header=TRUE, sep=";")
attach (plystats)

passmap  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/passmapmaydon.csv", header=TRUE, sep=";")
attach (passmap)

scorelist  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/scorelistmaydon.csv", header=TRUE, sep=";")
attach (scorelist)

summary  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/summarymaydon.csv", header=TRUE, sep=";")
attach (summary)

scores  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/scoresmaydon.csv", header=TRUE, sep=";")
attach (scores)

scrd  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/scrdmaydon.csv", header=TRUE, sep=";")
attach (scrd)

shots <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/shotsmaydon.csv", header=TRUE, sep=";")
attach (shots)

passtofrom  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/passtofrommaydon.csv", header=TRUE, sep=";")
attach (passtofrom)

attstats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/attstatsmaydon.csv", header=TRUE, sep=";")
attach (attstats)

origtime <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/origtimemaydon.csv", header=TRUE, sep=";")
attach (origtime)

shotstats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/shotstatsmaydon.csv", header=TRUE, sep=";")
attach (shotstats)

koeff <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/koeffmaydon.csv", header=TRUE, sep=";")
attach (koeff)

overview <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/overmaydon.csv", header=TRUE, sep=";")
attach (overview)

run <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/runmaydon.csv", header=TRUE, sep=";")
attach (run)

tabrun <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/tabrun.csv", header=TRUE, sep=";")
attach (tabrun)

passbd<- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/passbdmaydon.csv", header=TRUE, sep=";")
attach (passbd)
...
p + geom_point(data = positionB, aes(x=Areax, y=Areay, shape = Team), colour = "yellow",size = 6) +
  theme(plot.title = element_text( size=32, hjust=0)) +
...
# Plot
ggplot(overview, aes(x=Stats, y=Mayo)) + 
  geom_point(data = overview,aes(x=Stats, y=Mayo), col="lightgreen", size=10) +  
  geom_point(data = overview,aes(x=Stats, y=Donegal), col="yellow", size= 10) +
  geom_segment(aes(x=Stats, xend=Stats, y=min(Mayo), yend=max(Mayo)), 
  linetype="dashed", size=0.1,colour = "grey") +     
  coord_flip() +
geom_text(data = overview,aes(x=Stats, y=Mayo,label = Mayo), size = 6,col="red") +
geom_text(data = overview,aes(x=Stats, y=Donegal,label = Donegal), size = 6,col="lightgreen") +
my_theme ()
...
goal_theme <- function(){
  theme_classic() +
    theme(text = element_blank(),  
      ...
      annotate(geom="text", x= 1.50, y=3.5, label="Point - 14",color = "black",size = 14) + 
      annotate(geom="text", x= 2.50, y=3, label="Wide Right - 7",color = "black",size = 14) + 
      annotate(geom="text", x= .50, y=3, label="Wide Left - 4",color = "black",size = 14) + 
      annotate(geom="text", x= 1, y=.5, label="Short/Post - 5/1",color = "black",size = 14) + 
      annotate(geom="text", x= 2, y=.5, label="Save/Blkd - 2/1",color = "black",size = 14) +
      annotate(geom="text", x= 0.5, y=4.7, label="Mayo",color = "black",size = 18)  +
      annotate(geom="text", x= 0.5, y=4.4, label="Total Shots - 35",color = "black",size = 16)  +
      goal_theme ()
      ...
      annotate(geom="text", x= .50, y=3, label="Wide Left - 6",color = "black",size = 14) + 
      annotate(geom="text", x= 1, y=.5, label="Short/Post - 4/0",color = "black",size = 14) + 
      ...
      annotate(geom="text", x= 0.5, y=4.4, label="Total Shots - 27",color = "black",size = 16)  +
      goal_theme ()
...
ggplot(data=scores, aes(x=timeoc, y=score, group=Team)) +
    ...
    geom_point(data = wormB, shape = 1, size = 4, stroke = 2, colour = "lightgreen") +
    geom_point(data = wormC, shape = 4, size = 3, stroke = 2, colour = "red") +
    geom_point(data = wormD, shape = 4, size = 3, stroke = 2, colour = "lightgreen") +
    theme_classic() + 
    ...
    axis.title.x = element_blank()) +
    geom_text_repel(data = wormA, aes(x=timeoc, y=score, label = shotlab), size = 4, colour = "darkblue",  
    segment.size  = 0.2,  direction = "x", hjust = 1,nudge_x = -2, nudge_y = 2) + 
    geom_text_repel(data = wormB, aes(x=timeoc, y=score, label = shotlab), size = 4, colour = "darkblue",  
...
geom_text_repel(data = scores, aes(x=timeoc, y=scorediff, label = scrd),  size = 8) + 
 geom_vline(xintercept=39, linetype="dotted", color = "black") +
    annotate(geom="text", x=2, y=4.5, label="Mayo", color="black", size = 16) +
    annotate(geom="text", x=3.5, y=-4.5, label="Donegal", color="black", size = 12) +
    theme(plot.background = element_blank(),
...
linksABs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/linkskomaydon.csv", header=TRUE, sep=";")
attach (linksABs)

nodesteamAko <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/nodeskomaydon.csv", header=TRUE, sep=";")
attach (nodesteamAko)
...
nodesteamBko <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/nodeskodonmay.csv", header=TRUE, sep=";")
attach (nodesteamBko)
...
plot(netBko, edge.arrow.size=.4, edge.color="yellow",edge.arrow.width=.4,
      edge.width=E(netBko)$weight*5, layout=as.matrix(nodes.coordB[,c("x","y")]), vertex.label.color="lightgreen",  vertex.label = labkoB, vertex.label.cex = 5)
...
kable (attstats)%>% kable_styling(bootstrap_options=c("striped",full_width = F))%>%column_spec(1,bold = T)%>%add_header_above(c(" "= 1, "Mayo" = 2, "Donegal" = 2))
...
linksABps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/passshotmaydon.csv", header=TRUE, sep=";")
attach (linksABps)

nodesteamAps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/nodesshotmaydon.csv", header=TRUE, sep=";")
attach (nodesteamAps)
...
plot(netAps, edge.arrow.size=.4, edge.color="lightgreen",edge.arrow.width=.4,
      edge.width=E(netAps)$weight*5, layout=as.matrix(nodes.coordA[,c("x","y")]), vertex.label.color="red", vertex.label = labelAsh, vertex.label.cex = 5)
```
...
nodesteamBps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/nodesshotdonmay.csv", header=TRUE, sep=";")
attach (nodesteamBps)
...
plot(netBps, edge.arrow.size=.4, edge.color="yellow",edge.arrow.width=.4,
      edge.width=E(netBps)$weight*5, layout=as.matrix(nodes.coordB[,c("x","y")]), vertex.label.color="lightgreen",  vertex.label = labelBsh, vertex.label.cex = 5)
...
linksABs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/linksscoresmaydon.csv", header=TRUE, sep=";")
attach (linksABps)

nodesteamAs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/nodesscoremaydon.csv", header=TRUE, sep=";")
attach (nodesteamAs)
...
plot(netAs, edge.arrow.size=.4, edge.color="lightgreen",edge.arrow.width=.4,
...
nodesteamBs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/nodesscoredonmay.csv", header=TRUE, sep=";")
attach (nodesteamBs)
...
```{r, fig.width = 20, fig.height = 20}
linksAB <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/linksmaydon.csv", header=TRUE, sep=";")
attach (linksAB)

nodesteamA <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/nodesmaydon.csv", header=TRUE, sep=";")
attach (nodesteamA)
...
plot(netA, edge.arrow.size=.4, edge.color="lightgreen",edge.arrow.width=.4,
      edge.width=E(netA)$weight*5, layout=as.matrix(nodes.coordA[,c("x","y")]), vertex.label.color="red", vertex.label = labelA, vertex.label.cex = 5)
```
...
nodesteamB <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/maydon/nodesdonmay.csv", header=TRUE, sep=";")
attach (nodesteamB)
...
plot(netB, edge.arrow.size=.4, edge.color="yellow",edge.arrow.width=.4,
      edge.width=E(netB)$weight*5, layout=as.matrix(nodes.coordB[,c("x","y")]), vertex.label.color="lightgreen",  vertex.label = labelB, vertex.label.cex = 5)
