---
title: "Mayo (0.17) vs Roscommon (2.12)"
output:
  html_document:
    toc: true
    toc_float: true 
...
pass <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/passmayros.csv", header=TRUE, sep=";")
attach (pass)

position  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/positionmayros.csv", header=TRUE, sep=";")
attach (position)

plytree  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/plytreemayros.csv", header=TRUE, sep=";")
attach (plytree)

plystats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/plystatsmayros.csv", header=TRUE, sep=";")
attach (plystats)

passmap  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/passmapmayros.csv", header=TRUE, sep=";")
attach (passmap)

scorelist  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/scorelistmayros.csv", header=TRUE, sep=";")
attach (scorelist)

summary  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/summarymayros.csv", header=TRUE, sep=";")
attach (summary)

scores  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/scoresmayros.csv", header=TRUE, sep=";")
attach (scores)

scrd  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/scrdmayros.csv", header=TRUE, sep=";")
attach (scrd)

shots <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/shotsmayros.csv", header=TRUE, sep=";")
attach (shots)

passtofrom  <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/passtofrommayros.csv", header=TRUE, sep=";")
attach (passtofrom)

attstats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/attstatsmayros.csv", header=TRUE, sep=";")
attach (attstats)

origtime <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/origtimemayros.csv", header=TRUE, sep=";")
attach (origtime)

shotstats <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/shotstatsmayros.csv", header=TRUE, sep=";")
attach (shotstats)

koeff <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/koeffmayros.csv", header=TRUE, sep=";")
attach (koeff)

overview <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/overmayros.csv", header=TRUE, sep=";")
attach (overview)

run <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/runmayros.csv", header=TRUE, sep=";")
attach (run)
...
# Plot
ggplot(overview, aes(x=Stat, y=Mayo)) + 
  geom_point(data = overview,aes(x=Stat, y=Mayo), col="lightgreen", size=10) +  
  geom_point(data = overview,aes(x=Stat, y=Roscommon), col="blue", size= 10) +
  geom_segment(aes(x=Stat, xend=Stat, y=min(Mayo), yend=max(Mayo)), 
  linetype="dashed", size=0.1,colour = "grey") +     
  coord_flip() +
geom_text(data = overview,aes(x=Stat, y=Mayo,label = Mayo), size = 6,col="red") +
geom_text(data = overview,aes(x=Stat, y=Roscommon,label = Roscommon), size = 6,col="yellow") +
my_theme ()
...
goal_theme <- function(){
  theme_classic() +
    theme(text = element_blank(),  
      ...
      annotate(geom="text", x= 1.50, y=3.5, label="Point - 17",color = "black",size = 14) + 
      annotate(geom="text", x= 2.50, y=3, label="Wide Right - 4",color = "black",size = 14) + 
      annotate(geom="text", x= .50, y=3, label="Wide Left - 11",color = "black",size = 14) + 
      annotate(geom="text", x= 1, y=.5, label="Short/Post - 4/1",color = "black",size = 14) + 
      annotate(geom="text", x= 2, y=.5, label="Save/Blkd - 0/1",color = "black",size = 14) +
      annotate(geom="text", x= 0.5, y=4.7, label="Mayo",color = "black",size = 18)  +
      annotate(geom="text", x= 0.5, y=4.4, label="Total Shots - 38",color = "black",size = 16)  +
      goal_theme ()
      ...
      annotate(geom="text", x= 1.50, y=3.5, label="Point - 12",color = "black",size = 14) + 
      ...
      annotate(geom="text", x= 0.5, y=4.7, label="Roscommon",color = "black",size = 18)  +
...
ggplot(data=scores, aes(x=timeoc, y=score, group=Team)) +
    geom_step(data=wormA, aes(x=timeoc, y=score), colour = "lightgreen", ,size=2) + 
...
geom_vline(xintercept=17.5, linetype="dotted", color = "black") +
 ...
 geom_vline(xintercept=75, linetype="dotted", color = "black") +
    annotate(geom="text", x=2, y=4.5, label="Mayo", color="red", size = 16) +
    annotate(geom="text", x=3.5, y=-4.5, label="Roscommon", color="blue", size = 12) +
    theme(plot.background = element_blank(),
...
linksABs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/linkskomayros.csv", header=TRUE, sep=";")
attach (linksABs)

nodesteamAko <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/nodeskomayros.csv", header=TRUE, sep=";")
attach (nodesteamAko)
...
colrs <- c("lightgreen", "lightgreen", "lightgreen", "lightgreen", "lightgreen")
...
plot(netAko, edge.arrow.size=.4, edge.color="lightgreen",edge.arrow.width=.4,
      edge.width=E(netAko)$weight*5, layout=as.matrix(nodes.coordA[,c("x","y")]), vertex.label.color="red", vertex.label = labkoA, vertex.label.cex = 5)
...
nodesteamBko <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/nodeskorosmay.csv", header=TRUE, sep=";")
attach (nodesteamBko)
...
kable (attstats)%>% kable_styling(bootstrap_options=c("striped",full_width = F))%>%column_spec(1,bold = T)%>%add_header_above(c(" "= 1, "Mayo" = 2, "Roscommon" = 2))
...
linksABps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/passshotmayros.csv", header=TRUE, sep=";")
attach (linksABps)

nodesteamAps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/nodesshotmayros.csv", header=TRUE, sep=";")
attach (nodesteamAps)
...
nodesteamBps <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/nodesshotrosmay.csv", header=TRUE, sep=";")
attach (nodesteamBps)
...
linksABs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/linksscoresmayros.csv", header=TRUE, sep=";")
attach (linksABps)

nodesteamAs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/nodesscoremayros.csv", header=TRUE, sep=";")
attach (nodesteamAs)
...
plot(netAs, edge.arrow.size=.4, edge.color="red",edge.arrow.width=.4,
      edge.width=E(netAs)$weight*5, layout=as.matrix(nodes.coordA[,c("x","y")]), vertex.label.color="red", vertex.label = labAscr, vertex.label.cex = 5)
...
nodesteamBs <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/nodesscorerosmay.csv", header=TRUE, sep=";")
attach (nodesteamBs)
...
```{r, fig.width = 20, fig.height = 20}
linksAB <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/linksmayros.csv", header=TRUE, sep=";")
attach (linksAB)

nodesteamA <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/nodesmayros.csv", header=TRUE, sep=";")
attach (nodesteamA)
...
plot(netA, edge.arrow.size=.4, edge.color="lightgreen",edge.arrow.width=.4,
      edge.width=E(netA)$weight*5, layout=as.matrix(nodes.coordA[,c("x","y")]), vertex.label.color="lightgreen", vertex.label = labelA, vertex.label.cex = 5)
```
...
nodesteamB <- read.csv(file="c:/Users/donagh/OneDrive/Spreadsheet fun/PA Analytics/PA Template/mayros/nodesrosmay.csv", header=TRUE, sep=";")
attach (nodesteamB)
